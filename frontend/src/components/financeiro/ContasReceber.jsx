...
/* ═══════════════════════════════════════════════════════════
   COMPONENTE PRINCIPAL — ContasReceber
   ═══════════════════════════════════════════════════════════ */
function ContasReceber() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      valorRecebido: recebidas.reduce((s, c) => s + Number(c.valor || 0), 0),
  ...
  /* ── Loading ─────────────────────────────────────── */
  if (carregando) return <Loading text="Carregando contas a receber" />;
      ...
      <div style={S.searchBar}>
        <div style={S.searchInputWrap(searchFocused)}>
          ...
          <input
            ...
            placeholder="Buscar por descrição, paciente ou status..."
            style={S.searchInput}
          />
          {busca && (
        ...
        <EmptyState
          ...
          text={
            busca
              ...
              : "Cadastre a primeira conta a receber para começar a acompanhar suas receitas."
          }
          action={!busca ? "Nova conta a receber" : null}
          onAction={abrirNovo}
        />
      ) : (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ ...COL.paciente, minWidth: 0 }}>
                    <span style={c.paciente_nome ? S.cellText : S.cellEmpty}>
        ...
        <div style={S.modalOverlay} onClick={() => setModal(null)}>
          <div style={S.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={S.modalBody}>
              ...
              <div style={S.formRow}>
                <div style={S.formGroup}>
                  <label style={S.formLabel}>Paciente</label>
                  <input
                    style={S.formInput}
