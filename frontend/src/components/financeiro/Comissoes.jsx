...
const S = {
  ...
  searchInputWrap: (focused) => ({ flex: 1, minWidth: "220px", display: "flex", alignItems: "center", gap: "10px", height: "40px", borderRadius: "10px", border: `1px solid ${focused ? "#2563eb" : "#e2e8f0"}`, padding: "0 14px", background: "#fff", transition: "all 0.2s ease", boxSizing: "border-box", boxShadow: focused ? "0 0 0 3px rgba(37,99,235,0.1)" : "none" }),
  ...
  searchClear: { display: "flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", borderRadius: "50%", border: "none", background: "#f1f5f9", color: "#94a3b8", fontSize: "10px", cursor: "pointer", flexShrink: 0, lineHeight: 1, fontFamily: "inherit" },
  ...
  filterInput: { height: "40px", borderRadius: "10px", border: "1px solid #e2e8f0", padding: "0 14px", fontSize: "14px", color: "#0f172a", background: "#fff", outline: "none", transition: "all 0.2s ease", fontFamily: "inherit", boxSizing: "border-box" },
  btnPrimary: { display: "inline-flex", alignItems: "center", gap: "8px", border: "none", borderRadius: "10px", padding: "10px 20px", background: "#2563eb", color: "#fff", fontWeight: "600", fontSize: "14px", cursor: "pointer", boxShadow: "0 1px 3px rgba(37,99,235,0.2)", transition: "all 0.2s ease", whiteSpace: "nowrap", height: "40px", boxSizing: "border-box", fontFamily: "inherit" },
  btnSecondary: { display: "inline-flex", alignItems: "center", gap: "6px", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "0 16px", background: "#fff", color: "#475569", fontWeight: "500", fontSize: "13px", cursor: "pointer", transition: "all 0.15s ease", whiteSpace: "nowrap", height: "40px", boxSizing: "border-box", fontFamily: "inherit" },
  ...
  avatar: (color) => ({ width: "36px", height: "36px", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: color + "14", color: color, fontSize: "14px", fontWeight: "700" }),
  ...
  actionBtn: (hovered, color) => ({ width: "34px", height: "34px", borderRadius: "8px", border: hovered ? `1px solid ${color}20` : "1px solid transparent", background: hovered ? `${color}08` : "transparent", color: hovered ? color : "#64748b", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s ease", padding: 0, flexShrink: 0 }),
  ...
  formInput: { height: "40px", borderRadius: "10px", border: "1px solid #e2e8f0", padding: "0 14px", fontSize: "14px", color: "#0f172a", background: "#fff", outline: "none", transition: "all 0.2s ease", fontFamily: "inherit", boxSizing: "border-box" },
  formSelect: { height: "40px", borderRadius: "10px", border: "1px solid #e2e8f0", padding: "0 14px", fontSize: "14px", color: "#0f172a", background: "#fff", outline: "none", transition: "all 0.2s ease", fontFamily: "inherit", boxSizing: "border-box", cursor: "pointer" },
...
function Comissoes() {
  ...
  /* ── Fetch ─────────────────────────────────────────
     ✅ CORRIGIDO: envia mes/ano (params que o backend aceita)
     ✅ CORRIGIDO: backend retorna { comissoes: [...] }, não array
     ───────────────────────────────────────────────── */
  const carregar = () => {
    setCarregando(true);
  ...
  /* ✅ CORRIGIDO: rota /comissoes/:id/pagar */
  ...
  /* ✅ CORRIGIDO: usa POST /financeiro/profissionais */
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={S.statsGrid}>
        <StatCard label="Profissionais" value={stats.profissionais} icon={Icons.users} accent="#8b5cf6" sub="com comissões" />
      ...
      <div style={S.filterBar}>
        ...
        <button style={S.btnPrimary} onClick={() => { setConfigForm({ nome: "", especialidade: "", percentual_comissao: "", valor_fixo_comissao: "", tipo_comissao: "percentual" }); setModal("config"); }} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(37,99,235,0.3)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(37,99,235,0.2)"; }}>
        ...
        <div style={S.modalOverlay} onClick={() => setModal(null)}>
          <div style={S.modal} onClick={(e) => e.stopPropagation()}>
            <div style={S.modalHeader}>
              ...
              <button style={S.modalCloseBtn} onClick={() => setModal(null)} onMouseEnter={(e) => (e.currentTarget.style.background = "#f1f5f9")} onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}>{Icons.x}</button>
            </div>
            <div style={S.modalBody}>
              <div style={S.formGroup}>
                <label style={S.formLabel}>Nome do profissional *</label>
                <input style={S.formInput} value={configForm.nome || ""} onChange={(e) => setConfigForm((prev) => ({ ...prev, nome: e.target.value }))} onFocus={handleInputFocus} onBlur={handleInputBlur} placeholder="Nome do profissional" />
              </div>
              <div style={S.formGroup}>
                <label style={S.formLabel}>Especialidade</label>
                <input style={S.formInput} value={configForm.especialidade || ""} onChange={(e) => setConfigForm((prev) => ({ ...prev, especialidade: e.target.value }))} onFocus={handleInputFocus} onBlur={handleInputBlur} placeholder="Ex: Ortodontia, Implantes..." />
              </div>
              <div style={S.formRow}>
                <div style={S.formGroup}>
                  <label style={S.formLabel}>Tipo de comissão</label>
                  <select style={S.formSelect} value={configForm.tipo_comissao || "percentual"} onChange={(e) => setConfigForm((prev) => ({ ...prev, tipo_comissao: e.target.value }))} onFocus={handleInputFocus} onBlur={handleInputBlur}>
                    <option value="percentual">Percentual (%)</option>
                    <option value="fixo">Valor fixo (R$)</option>
                  </select>
                </div>
                <div style={S.formGroup}>
                  <label style={S.formLabel}>{configForm.tipo_comissao === "percentual" ? "Percentual (%)" : "Valor fixo (R$)"}</label>
                  <input type="number" step={configForm.tipo_comissao === "percentual" ? "0.5" : "0.01"} min="0" max={configForm.tipo_comissao === "percentual" ? "100" : undefined} style={S.formInput} value={configForm.tipo_comissao === "percentual" ? (configForm.percentual_comissao || "") : (configForm.valor_fixo_comissao || "")} onChange={(e) => setConfigForm((prev) => ({ ...prev, ...(prev.tipo_comissao === "percentual" ? { percentual_comissao: e.target.value } : { valor_fixo_comissao: e.target.value }) }))} onFocus={handleInputFocus} onBlur={handleInputBlur} placeholder={configForm.tipo_comissao === "percentual" ? "Ex: 30" : "Ex: 150,00"} />
                  <span style={S.formHint}>{configForm.tipo_comissao === "percentual" ? "Percentual sobre cada atendimento" : "Valor fixo por atendimento"}</span>
                </div>
              </div>
            </div>
            <div style={S.modalFooter}>
              <button style={S.btnSecondary} onClick={() => setModal(null)} onMouseEnter={(e) => (e.currentTarget.style.background = "#f8fafc")} onMouseLeave={(e) => (e.currentTarget.style.background = "#fff")}>Cancelar</button>
              <button style={S.btnPrimary} onClick={salvarConfig} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(37,99,235,0.3)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 1px 3px rgba(37,99,235,0.2)"; }}>Salvar profissional</button>
            </div>
          </div>
        </div>
      )}
